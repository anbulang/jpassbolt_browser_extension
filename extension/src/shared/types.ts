 ...
 * transactional emails are sent and how much content they include. The POST
 * accepts a PARTIAL object and the backend merges it, returning the full set.
 */
 ...
 * card is read-only). Only the fields the read-only summary surfaces are typed;
 * the generator sub-objects stay open-ended.
 */
